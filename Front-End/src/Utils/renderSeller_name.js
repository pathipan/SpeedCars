  ...
  render() {
    ...
    return (
      <div className="form-group row">
        <label className="col-sm-4 col-form-label"><img src="/images/id_card.png" width="20px" height="20px"/> ชื่อผู้ขาย</label>
        <div className="col-sm-8">
          <input {...input} className="form-control" value={this.props.data.name}/>
