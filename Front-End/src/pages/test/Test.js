  ...
  return (
    ...
    >
      ...
      <h3 className=" orange-text ">
        <MDBIcon icon="sort-amount-down-alt" /> ขั้นตอนที่ 1/4 รายละเอียดรถ
      </h3>
      ...
      <hr />
      <h3 className=" orange-text ">
        <MDBIcon icon="sort-amount-down-alt" /> ขั้นตอนที่ 3/4 ข้อมูลผู้ขาย
      </h3>
      <hr />
      <div className="container">
        <Form.Group>
          <Row>
            <Col md={6}>
              <Form.Label>
                <img src="/images/id_card.png" width="30" />
              </Form.Label>
              <input
                placeholder="ชื่อผู้ขาย"
                className="form-control"
                type="text"
                value={seller_nameType}
                onChange={(e) => {
                  setSeller_nameType(e.target.value);
                }}
                outline
                style={{ color: "#8000FF" }}
              />
            ...
            <Col md={6}>
              ...
              <input
                ...
                className="form-control"
                type="text"
                value={seller_facebookType}
                onChange={(e) => {
                  setSeller_facebookType(e.target.value);
                }}
                outline
                style={{ color: "#8000FF" }}
              />
          ...
          <Row>
            <Col md={6}>
              ...
              <input
                ...
                className="form-control"
                type="text"
                value={seller_lineType}
                onChange={(e) => {
                  setSeller_lineType(e.target.value);
                }}
                outline
                style={{ color: "#8000FF" }}
              />
            ...
            <Col md={6}>
              <Form.Label>
                <img src="/images/telephone.png" width="30" />{" "}
              </Form.Label>
              <input
                placeholder="เบอร์ที่สามารถติดต่อได้"
                type="text"
                className="form-control"
                value={seller_phoneType}
                onChange={(e) => {
                  setSeller_phoneType(e.target.value);
                }}
                outline
                style={{ color: "#8000FF" }}
              />
